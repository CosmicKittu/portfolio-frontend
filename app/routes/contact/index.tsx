...
//     if(!name) errors.subject="Subject is required";
//     if(!name) errors.message="Message is required";
...
const ContactPage = ({actionData}: Route.ComponentProps) => {
    return ( 
        ...
        <div className="max-w-3xl mx-auto mt-12 px-6 py-8 bg-gray-900">
            ...
            {/* {actionData?.message ? <p className="mb-6 bg-green-700  text-green-100 text-center rounded-lg border-green-500 shadow-md p-4">{actionData.message}</p> : null} */}
            <form action='https://formspree.io/f/mqadrjod' method='post' className="space-y-6">
                <div>
                ...
                <button className="w-full cursor-pointer bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700">
                    Send Message
                </button>
            </form>
        </div>
